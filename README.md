# py-feat
A comprehensive set of tools and models to easily detect facial expressions (AU, emotions, facial landmarks) from images and videos, preprocesses and analyse facial expressions data and visualise facial expression data
Py-Feat: Python Facial Expression Analysis Toolbox
Package versioning Tests Coverage Status Python Versions GitHub forks GitHub stars DOI
